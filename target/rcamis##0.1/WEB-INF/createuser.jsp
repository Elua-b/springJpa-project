	...
	<div class="flex items-center justify-center h-screen">
		<form action="createuser.php?page=createuser" method="post" class="w-1/3 mx-auto h-3/4 bg-white shadow-md shadow-indigo-200 rounded">
			...
			<div class="flex flex-col space-y-8 p-4 w-2/3 mx-auto" >
				...
				<input type="email" placeholder="email" size="25" name="email" id="email" class="block border rounded w-full outline-none p-2" />
				<input type="text" placeholder="full name" name="userfullname" class="block border rounded w-full outline-none p-2" />
				...
				<p class="text-center">Already have an account?<a class="text-blue-500" href="/rcamis_war/">Log in</a></p>
